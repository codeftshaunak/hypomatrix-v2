...
const BgGridEffect = (props: Props) => {
  return (
    <div className="select-none w-full min-h-screen absolute top-0 lg:-bottom-16 left-0 overflow-hidden -z-[1]">
      ...
      <div className="absolute right-0 size-[400px] blur-[100px] xl:size-[560px] xl:blur-[200px] md:bg-primary/80 rounded-full translate-x-1/2 -translate-1/2"></div>
      <div className="absolute left-1/2 bottom-0 size-[500px] blur-[400px] md:bg-primary/60 rounded-full -translate-x-1/2 translate-y-1/2"></div>
